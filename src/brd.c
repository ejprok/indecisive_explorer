...
const Bitboard notAFile = 0b011111110111111101111111011111110111111101111111;
const Bitboard notHFile = 0b111111101111111011111110111111101111111011111110;
...
void init_board() {
    ...
    game_board.comp_kings     = 0b000000000000000000000000000000000010000000000000000000011000;
